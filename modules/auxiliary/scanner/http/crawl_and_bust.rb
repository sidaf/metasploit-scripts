...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize
    super(
      'Name'        => 'Web Site Crawler and Directory/File Buster',
      'Description' => 'Crawl and discover unlinked content within a web site and store information about what was found.',
      'Author'      => %w(hdm tasos sion.dafydd[at]gmail.com),
      'License'     => MSF_LICENSE
    )
